...
document.write("<style>.drive-viewer-popout-button{display:none;}</style><iframe style=\"width:100%; height:93%\" id=\"mediaplayer\" src=\""+idx+"\"><noscript>&nbsp;Enable Javascript to Load File<\/noscript><\/iframe>");
